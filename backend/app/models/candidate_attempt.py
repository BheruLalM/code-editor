...
class CandidateAttempt(Base):
    ...
    session_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("test_sessions.id"), nullable=False)
    ...
    assigned_problem_id: Mapped[str] = mapped_column(ForeignKey("problems.id"), nullable=False)
